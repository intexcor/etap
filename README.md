...
Видеоплатформа для обучения: главная с роликами, вертикальная лента, поиск; курсы из любого материала: конспект, PDF лекции, глава учебника, код.
...
| `web/src/` | React + Vite + Tailwind 4 + React Router + TanStack Query, PWA. Страницы: главная (сетка роликов с клиентскими превью-кадрами), общая лента `/feed`, поиск, мои курсы, создание, экран обучения `/c/:id` (уроки | плеер | урок/спросить), повтор, профиль |
